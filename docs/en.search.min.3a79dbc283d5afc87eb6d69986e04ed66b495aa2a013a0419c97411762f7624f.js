...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2a9264157ca9698fb34c9fabbc0cb05f81ca40bfa6197bb9e556158cad91b987.js',function(){input.required=false;search();});}
