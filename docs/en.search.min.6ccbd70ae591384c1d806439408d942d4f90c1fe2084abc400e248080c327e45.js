...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8436a5b2aa20f719057308448721244eb26a599ce6edbb4c0b1c83df08e5a099.js',function(){input.required=false;search();});}
