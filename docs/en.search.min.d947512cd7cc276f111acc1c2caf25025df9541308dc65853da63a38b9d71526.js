...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/physics-website/flexsearch.min.js');loadScript('/physics-website/en.search-data.min.a9033863466ff4eeda1af41c5212d18f265bd07aeaefd16e0c3218bded4c2099.js',function(){input.required=false;search();});}
