...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4ed479e6dc33c458449597e2df90f9989710a889547fe8ace2d835e3de167bee.js',function(){input.required=false;search();});}
