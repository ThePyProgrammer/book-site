...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e6012520c13b32d8c3a97cea7d5f872d7a65e03bcdc2cfc54a42fe7cee9b90d0.js',function(){input.required=false;search();});}
