...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.adf59f50cf2a1d0429581901ddeb8570d8275a5ea98b5b15b74d61b7060ee90a.js',function(){input.required=false;search();});}
