...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.399c2b699988dffa92ea9f7835dee34f0661ca37d4fe22bd5a21bd6d131c42e0.js',function(){input.required=false;search();});}
